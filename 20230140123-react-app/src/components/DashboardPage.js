          ...
          {userRole === 'admin' ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <button 
                ...
                className="p-6 bg-gradient-to-br from-red-400 to-red-600 text-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
                <div className="text-4xl mb-2">📊</div>
                <div className="font-semibold">Laporan</div>
              </button>
              <button 
                onClick={() => navigate('/presensi')}
                className="p-6 bg-gradient-to-br from-green-400 to-green-600 text-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
                <div className="text-4xl mb-2">✅</div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <button 
                onClick={() => navigate('/presensi')}
                className="p-6 bg-gradient-to-br from-blue-400 to-blue-600 text-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
                <div className="text-4xl mb-2">📝</div>
                <div className="font-semibold">Presensi</div>
              </button>
              <button 
                onClick={() => navigate('/report')}
                className="p-6 bg-gradient-to-br from-purple-400 to-purple-600 text-white rounded-xl shadow-md hover:shadow-xl transform hover:scale-105 transition duration-300">
                <div className="text-4xl mb-2">📊</div>
                <div className="font-semibold">Laporan</div>
              </button>
            </div>
